...
const Home: NextPage = () => {
  ...
  const [defaultGameList, _setDefaultGameList] = useState<any>([
    {
      price: 100,
      id: 540,
      title: "Overwatch 2",
  ...
  const handleSearch = () => {
    const searchGame = defaultGameList.filter((game: { title: string }) =>
      game.title.toLowerCase().includes(value)
    );
    setAllGameList(searchGame);
  };
  const handleSearchReset = () => {
    setValue("");
    setAllGameList(defaultGameList);
  };
